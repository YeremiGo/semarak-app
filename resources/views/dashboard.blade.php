...
@section('content')
    ...
    {{-- (PERUBAHAN) Beri ID pada form agar mudah ditemukan oleh JavaScript --}}
    <form id="filterForm" action="{{ route('dashboard') }}" method="GET" class="flex items-center space-x-2 mb-4">
        ...
        <div class="flex items-center space-x-4">
            ...
            {{-- (PERUBAHAN) Tombol Filter dan Reset dihapus --}}
        </div>
    </form>
